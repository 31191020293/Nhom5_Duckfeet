    ...
    <body>
        <div class="fullcontainer">
                    ...
                    <div class = "bs">
                        <div id = "demo" class = "carousel slide" data-ride="carousel">
                            ...
                            <div class = "carousel-inner">
                                ...
                                <div class = "carousel-caption">
                                    <h5 style="color: gray">BỘ SƯU TẬP <span class = "badge badge-secondary">Colection</span></h5>
                                </div>
                            </div>
                    ...
                    <div class = "bs">
                        <div id = "demo" class = "carousel slide" data-ride="carousel">
                            ...
                            <div class = "carousel-inner">
                                ...
                                <div class = "carousel-caption">
                                    <h5 style="color: gray">SẢN PHẨM MỚI <span class = "badge badge-primary">New</span></h5>
                                </div>
                            </div>
            ...
            <div class="container" style="text-align: center">  
                <?php
                    echo "<h2 style='margin-top: 15px; text-align: center'>SẢN PHẨM</h2>";
