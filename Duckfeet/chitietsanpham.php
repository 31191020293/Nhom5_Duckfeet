        ...
        <div class="fullcontainer">
            ...
            <header class="header header_pc" style="float: left;">
                <div class="header_pc">
                    ...
                    <div class="menu" style="width: 60%; margin-left: 3%; margin-right: 0%; padding-left: 0%; font-size: 18px">
                        <ul>
            ...
            <div class="header_mobile" style="float:left;">
                ...
                <div class="menu_header-mobile">
                    ...
                    <div class="menu header_mobile_logo" id="lookup" action="timkiem.php">
                    ...
                    <div class="col-12">
                        <div class="bread-inner" style="margin-top: 15px">
                            <ul class="bread-list">
                                ...
                                <li class="active" style="font-size: 17px">Chi tiết</li>
                            </ul>
                        </div>
                    </div>
                </div>
